        ...
        <div className="font-[Quicksand]">
            ...
            {showMore && (
                <>
                    ...
                    <p>
                        I&rsquo;m passionate about building impactful applications and constantly strive to improve my problem-solving and development skills. I&rsquo;m always open to opportunities that challenge me and help me grow as a Fullstack developer.
                    </p>
                    {/* Show Less Button */}
                    <div className='flex flex-row justify-center text-violet-200 font-bold items-center gap-2 mt-4'>
