    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 font-[Quicksand] md:grid-cols-2 gap-4 p-4">
                <div className="border-none group grid grid-cols-[20%_80%] rounded-2xl p-4 bg-gradient-to-b from-cyan-900/90 to-cyan-700/40 shadow-md transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl hover:border-cyan-400">
                    <div>
