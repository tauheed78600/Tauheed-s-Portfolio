    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 p-4'>
                <div className='relative bg-gradient-to-b from-cyan-700/60 to-cyan-900/40 p-6 rounded-lg shadow-md transition-transform duration-300 hover:scale-105'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 p-4'>
                <div className='relative bg-gradient-to-b from-cyan-900/10 to-cyan-900/60 p-6 rounded-lg shadow-md transition-transform duration-300 hover:scale-105'>
