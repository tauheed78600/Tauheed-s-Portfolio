        ...
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 p-4'>
                <div className='relative bg-gradient-to-bl from-black to-violet-700  p-6 rounded-lg shadow-md transition-transform duration-300 hover:scale-105'>
                    <Image src="/eye.png" alt="Problem Solving Icon" width={64} height={64} className="absolute -top-4 -left-0 w-16 h-16 z-10" />
                ...
                <div className='relative bg-gradient-to-bl from-black to-violet-700  p-6 rounded-lg shadow-md transition-transform duration-300 hover:scale-105'>
                    <Image src="/code.png" alt="Creative Code Icon" width={64} height={64} className="absolute -top-4 -left-0 w-16 h-16 z-10" />
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 p-4'>
                <div className='relative bg-gradient-to-bl from-black to-violet-700  p-6 rounded-lg shadow-md transition-transform duration-300 hover:scale-105'>
                    <Image src="/vr.png" alt="Future Focused Icon" width={64} height={64} className="absolute -top-4 -left-0 w-16 h-16 z-10" />
                ...
                <div className='relative bg-gradient-to-bl from-black to-violet-700  p-6 rounded-lg shadow-md transition-transform duration-300 hover:scale-105'>
                    <Image src="/languages.png" alt="Global Fluency Icon" width={64} height={64} className="absolute -top-4 -left-0 w-16 h-16 z-10" />
