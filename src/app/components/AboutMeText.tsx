    ...
    return (
        <div>
            <p className="font-[Quicksand]">
                ...
                I specialize in full-stack development with hands-on experience in the <strong>MERN stack (MongoDB, Express.js, React.js, Node.js), Next.js, NestJS, and TypeScript.</strong><br />
