    ...
    <div className="text-white">
      <div className="flex flex-row items-center justify-between h-20 md:h-auto">
        ...
        <div className="w-full md:w-[70%] rounded-tr-[25px] rounded-bl-[25px] bg-gradient-to-tr from-black to-violet-700 border-black flex items-center invisible md:visible justify-center shadow-lg transition-all duration-300">
          <div className="text-violet-200 font-[Quicksand] text-lg font-semibold flex flex-row flex-wrap p-4 gap-4 md:gap-6  w-full justify-center">
            <button
      ...
      <div className="fixed bottom-0 backdrop-blur left-0 w-full border-black border-[0.5px] rounded-tr-[25px] rounded-tl-[25px] p-4 text-center bg-gradient-to-b from-violet-900/60 to-violet-700/40 z-50 block md:hidden">
