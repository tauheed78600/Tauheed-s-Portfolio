            ...
            <div className="flex flex-col items-center justify-between mb-4 mt-1">
                ...
                <div className="border-b-[0.5px] border-b-white flex flex-col gap-3 w-full h-auto">
                    ...
                    <div className="flex justify-center">
                        <button className="bg-cyan-700 mb-3 w-[90%] h-8 font-[Open_Sans] text-white  rounded-full shadow-[0_0_20px_5px_rgba(59,250,246,0.75)] transition duration-300 hover:bg-cyan-800">
                            Hello World
                        </button>
                    </div>
                </div>
                {/* lower sidebar */}
                <div className="flex flex-col mt-3 items-center gap-4 w-full p-4 bg-gradient-to-b from-cyan-900/60 to-cyan-700/40 rounded-xl shadow-inner">
