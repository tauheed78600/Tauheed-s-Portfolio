...
export default function SidebarProfile() {
    return (
        <div>
            <div className="md:sticky flex flex-col items-center justify-between mb-4 mt-1">
                {/* upper sidebar */}
                <div className="border-b-[0.5px] border-b-white flex flex-col gap-3 w-full h-[150px]">
                    <div className="flex flex-row gap-4">
                        <div className="border-[0.5px] border-white w-20 h-20 rounded-full bg-gradient-to-tr from-cyan-500 to-blue-900 flex items-center justify-center shadow-lg">
                    ...
                    <div className="flex justify-center">
                        <button className="bg-cyan-700 w-[90%] h-8 font-[Open_Sans] text-white  rounded-full shadow-[0_0_20px_5px_rgba(59,250,246,0.75)] transition duration-300 hover:bg-cyan-800">
                            Hello World
                        </button>
                    </div>
                </div>
                {/* lower sidebar */}
                <div className="flex flex-col items-center gap-4 w-full mt-6 p-4 bg-gradient-to-b from-cyan-900/60 to-cyan-700/40 rounded-xl shadow-inner">
                    <h3 className="font-[Quicksand] font-semibold text-lg text-cyan-200 mb-2">Connect with me</h3>
                    ...
                    <div className="w-full bg-cyan-800/30 rounded-lg p-3 flex flex-col items-center">
